            ...
            <ul class="pb-2 space-y-2">
              ...
              <li>
                ...
                <ul id="dropdown-crud" class="hidden py-2 space-y-2 ">
                  <li>
                    <a href="https://flowbite-admin-dashboard.vercel.app/crud/products/" class="flex items-center p-2 text-base text-gray-900 transition duration-75 rounded-lg group hover:bg-gray-100 pl-11 dark:text-gray-200 dark:hover:bg-gray-700 ">Products</a>
                  </li>
                  <li>
                    <a href="https://flowbite-admin-dashboard.vercel.app/crud/users/" class="flex items-center p-2 text-base text-gray-900 transition duration-75 rounded-lg group hover:bg-gray-100 pl-11 dark:text-gray-200 dark:hover:bg-gray-700 ">Users</a>
                  </li>
                </ul>
              </li>
              <li>
              ...
              <li>
                ...
                <ul id="dropdown-playground" class="hidden py-2 space-y-2 ">
                  <li>
                    <a href="https://flowbite-admin-dashboard.vercel.app/playground/stacked/" class="flex items-center p-2 text-base text-gray-900 transition duration-75 rounded-lg group hover:bg-gray-100 pl-11 dark:text-gray-200 dark:hover:bg-gray-700 ">Stacked</a>
                  </li>
                  <li>
                    <a href="https://flowbite-admin-dashboard.vercel.app/playground/sidebar/" class="flex items-center p-2 text-base text-gray-900 transition duration-75 rounded-lg group hover:bg-gray-100 pl-11 dark:text-gray-200 dark:hover:bg-gray-700 ">Sidebar</a>
                  </li>
                </ul>
              </li>
            </ul>
...
<aside
  v-if="false"
    class="bg-white absolute left-0 top-0 z-9999 flex h-screen w-72.5 flex-col overflow-y-hidden duration-300 ease-linear dark:bg-boxdark lg:static lg:translate-x-0"
    :class="{
  ...
  >
    ...
    <div class="flex items-center justify-between gap-2 px-6 py-5.5 lg:py-6.5">
      <router-link to="/">
        <Logo class="h-10 my-3" />
      </router-link>

      <button class="block lg:hidden" @click="uiStore.isSidebarOpen = false">
        <svg
          class="fill-current"
          width="20"
          height="18"
